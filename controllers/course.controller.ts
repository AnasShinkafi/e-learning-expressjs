...
export const addReview = CatchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const courseExists = useCourseList?.some(
        (course: any) => course._id.toString() === couldStartTrivia.toString()
      );
      if (!courseExists) {
        return next(
...
export const getAllCoursesByAdmin = CatchAsyncErrors(async(req: Request, res: Response, next: NextFunction) => {
  try {
