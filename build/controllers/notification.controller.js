...
exports.getNotification = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    try {
...
node_cron_1.default.schedule("0 0 0 * * *", async () => {
    ...
    await notification_model_1.default.deleteMany({ status: "read", createdAt: { slt: thirtyDaysAgo } });
});
