...
exports.newPayment = exports.sendStripePublishedKey = exports.getAllOrders = exports.CreateOrder = void 0;
...
exports.CreateOrder = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    try {
        ...
        if (!course) {
            return next(new ErrorHandler_1.default("Not found", 400));
        }
        ;
        const data = {
            courseId: course._id,
...
exports.sendStripePublishedKey = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    res.status(200).json({
