...
exports.deleteUser = exports.updateUserRole = exports.getAllUsers = exports.updateProfilePicture = exports.updatePassword = exports.updateUserInfo = exports.socialAuth = exports.getUserInfo = exports.updateAccessToken = exports.logoutUser = exports.loginUser = exports.activatedUser = exports.createActivationToken = exports.registrationUser = void 0;
...
exports.activatedUser = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    try {
...
exports.loginUser = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    try {
        ...
        if (!email || !password) {
            return next(new ErrorHandler_1.default("Please enter valid credential", 400));
        }
